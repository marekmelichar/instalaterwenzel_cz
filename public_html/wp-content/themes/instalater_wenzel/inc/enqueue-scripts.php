...
function default_theme_scripts()
{
	...
	wp_enqueue_style(
		'default-library', get_template_directory_uri() . '/css/own_library.css'
	);
	...
	wp_enqueue_style(
		'default-animations', get_template_directory_uri() . '/css/animations.css'
	);
	...
	wp_enqueue_style(
		'ion-icons', get_template_directory_uri() . '/css/ionicons.css'
	);
	...
	wp_enqueue_style(
		'navigation', get_template_directory_uri() . '/css/navigation.css'
	);
